---
id: faq-network-maintainer
title: FAQ for Network Maintainer
sidebar_label: Network Maintainer
---

## Bagaimana cara menjadi validator?

Baca: [cara menjadi validator](https://github.com/nusantarachain/nuchain/wiki/Menjadi-Validator)
